...
if(DEFINED SQLITE3_INCLUDE_PATH)
  message(AUTHOR_WARNING "Setting SQLITE3_INCLUDE_PATH is deprecated. SQLite_INCLUDE_DIR should be set instead.")
  set(SQLite_INCLUDE_DIR ${SQLITE3_INCLUDE_PATH})
endif()
if(DEFINED SQLITE3_LIBRARY)
  message(AUTHOR_WARNING "Setting SQLITE3_LIBRARY is deprecated. SQLite_LIBRARY should be set instead.")
  set(SQLite_LIBRARY ${SQLITE3_LIBRARY})
endif()
...
check_symbol_exists(fallocate    "${CFG_HEADERS}" HAVE_FALLOCATE)
if(IS_PY2)
