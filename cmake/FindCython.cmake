...
if(PYTHONINTERP_FOUND)
  ...
  find_program(CYTHON_EXECUTABLE
               NAMES cython cython.bat cython3 cython3.bat
               HINTS
                 "${_python_path}"
                 "${_python_path}/Scripts"
               DOC "path to the cython executable")
...
if (NOT CYTHON_EXECUTABLE)
  message(STATUS "Trying to find Cython using the module as a fallback.")
  execute_process(COMMAND ${Python3_EXECUTABLE} -m pip show cython
                  RESULT_VARIABLE EXIT_CODE
                  OUTPUT_QUIET)

  # Cython module was found
  if (${EXIT_CODE} EQUAL 0)
    set(CYTHON_EXECUTABLE ${Python3_EXECUTABLE} -m cython)
  endif()
endif()
